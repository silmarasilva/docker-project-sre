...
# Retornando o registro de um ID específico
...
# No put, precisa passar o ID na rota, mas no body eu posso manter o mesmo, ou colocar o número novo a ser alterado.
